...
/* refer to the syntax here: https://css-tricks.com/almanac/selectors/a/attribute/  These [ content within ] are all attributes that exist in the html file*/
    ...
    constructor(previousOperandTextElement, currentOperandTextElement) { 
        ...
        this.clear()
            ...
            */
            ...
            delete() { 
                this.currentOperand = this.currentOperand.toString().slice(0, -1) /* this removes one character 
            ...
            appendNumber(number) { 
                ...
                if(number ==='.' && this.currentOperand.includes('.')) return /*incluldes return true or false after
            ...
            chooseOperation(operation) { 
                if(this.currentOperand === '') return /* if value is null, there is no calculation required: return*/
                if (this.previousOperand !=='') { /*with values in previousOperand and there is a need to calculate
                ...
                this.operation = operation /*this passes argument into and initiates the value of operation 
                in this case it will be one of the chosen 4 operators + , -, /, * .         */
                this.previousOperand = this.currentOperand  /*this passes the value into previousOperand constant*/
                this.currentOperand ='' /* clears the value in currentOperate and waits for us to key in new values */
            ...
            compute() {
                ...
                if (isNaN(prev) || isNaN(current)) return /* check if either is not a number */
                switch (this.operation) { /*using the value found in operation execute accordingly to cases */
                    case '+': 
                    prev + current
                    break
                ...
                default: /*where none of the values match the above cases no computation is done */ 
                return
                }
                
                this.currentOperand = computation /* these few lines of code in this section does not update
                ...
                this.operation = undefined /*once operation is completed, operand is set to undefined */
            ...
            getDisplayNumber(number) 
                ...
                digits */
                    ...
                    const stringNumber = number.toString() /*changes number to string and saves in stringNumber */
                    ...
                    let numberDisplay
                    if (isNaN(integerNumber)) { /*if the value not present or not a number set value to null */
                        numberDisplay=''
                    }
                    else { 
            ...
            updateDisplay() { 
                ...
                if (this.operation !=null) { /*where the operation sign is present, the code below updates the html value 
                    in previousOperandTextElement*/
                
                    this.previousOperandTextElement.innerText =
                    `${this.getDisplayNumber(this.previousOperand)} ${this.operation}`
                
                } else { /*where sign is not present meaning no operation button is pressed value set to null */
                    this.previousOperandTextElement.innerText=''
                }
        ...
        const previousOperandTextElement = document.querySelector('[data-prior-operand]')
        ...
        numberButtons.forEach(button => { /* arrow function to initiate block code */
            button.addEventListener('click', () => { 

            /* every button event triggers appendNumber and appends the innerText in that button */
                calculator.appendNumber(button.innerText) /*calls appendNumber function in calculator object */
